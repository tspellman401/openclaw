...
const SECRET_MAPPINGS: readonly SecretMapping[] = [
  ...
  { envVar: "NOVITA_API_KEY", provider: "novita", profileId: "novita:hermes-import" },
  ...
  { envVar: "KIMI_CN_API_KEY", provider: "kimi-coding", profileId: "kimi-coding:hermes-import" },
  ...
  { envVar: "OLLAMA_API_KEY", provider: "ollama-cloud", profileId: "ollama-cloud:hermes-import" },
